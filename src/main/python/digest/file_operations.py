...
def prepare_file_structure(transactions_dir: str, transaction_date: datetime, csv_file_header: str) -> None:
...
def create_new_dir(parent_dir: str, folder: int) -> None:
    os.mkdir(f"{parent_dir}\\{folder}")


def create_new_txt_file(parent_dir: str, filename: int, csv_file_header: str) -> None:
